...
class EstimateSandboxRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'needs_designing_cost' => ['required', 'boolean'],
            ...
            'drip_off_setup_pricing_item_id' => [
                'exclude_unless:needs_drip_off,1',
                'required_if:needs_drip_off,1',
                Rule::exists('pricing_items', 'id'),
                $this->pricingItemRule('drip-off', ['New Job with Pasting', 'Repeat Job with Pasting']),
            ],
    ...
    public function attributes(): array
    {
        return [
            ...
            'needs_designing_cost' => 'apply design cost',
            ...
            'drip_off_setup_pricing_item_id' => 'drip off setup option',
