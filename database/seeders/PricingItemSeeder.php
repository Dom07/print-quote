...
class PricingItemSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $items = [
            ...
            ['pasting', '8 Sides Pasting', 'eight-sides-pasting', '0.9000', 'piece', RateType::PerPiece, false],
            ['pasting', '8 Sides Pasting With Checking', 'eight-sides-pasting-with-checking', '1.0000', 'piece', RateType::PerPiece, false],
