...
class PricingItemSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $items = [
            ...
            ['pasting', '4 Sides Pasting', 'four-sides-pasting', '0.4000', 'sheet', RateType::PerSheet, false],
            ['pasting', '4 Sides Pasting With Checking', 'four-sides-pasting-with-checking', '0.4500', 'sheet', RateType::PerSheet, false],
            ['pasting', '8 Sides Pasting', 'eight-sides-pasting', '0.9000', 'sheet', RateType::PerSheet, false],
            ['pasting', '8 Sides Pasting With Checking', 'eight-sides-pasting-with-checking', '1.0000', 'sheet', RateType::PerSheet, false],
